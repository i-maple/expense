...
async function GET(request) {
    try {
        ...
        if (!token || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token)) {
        ...
        const expenses = await db.collection('expenses').find(query).sort({
            date: -1
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3c6e692._.js.map