...
// Validate ../../../src/app/api/init-data/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/init-data">> = Specific
  const handler = {} as typeof import("../../../src/app/api/init-data/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
